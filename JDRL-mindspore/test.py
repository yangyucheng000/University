...
parser.add_argument('--dataset', default='DPDD', help="dataset DPDD or SDD")
...
parser.add_argument('--model', default='MPRNet', help="only MPRNet")
...
for i in range(len(ckpt_list)):
    ...
    ckpt = mindspore.load_checkpoint(ckpt_path_load)
    ckpt_name = ckpt_name_list[i]
    print("loading checjpoint'{}'".format(ckpt_path_load))
    print(i)
    ssim_av, psnr_av, mse_av = test_state(args, ckpt)
...
print('psnr: {}, ssim: {}'.format(best_psnr, best_ssim))
